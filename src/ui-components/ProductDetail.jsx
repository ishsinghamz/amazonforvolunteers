      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7ogh")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerfaa")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7zxn")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerclk")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7cyd")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28htj")}
          >
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttonksu")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonjzj")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonulj")}
            ></Button>
            <Button
              display="flex"
              gap="0"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonhwi")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28vye")}
          >
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="L"
              {...getOverrideProps(overrides, "Buttonzjw")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttondpr")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonovv")}
            ></Button>
            <Button
              display="flex"
              gap="24px"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttoncuy")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
