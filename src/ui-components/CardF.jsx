      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgevhi")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgesbx")}
          ></Badge>
          <Badge
            display="flex"
            gap="10px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgepjg")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featureule")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconyas")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorcyd")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurekxw")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconudb")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorkxa")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurejkm")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconvnq")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorgqo")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
