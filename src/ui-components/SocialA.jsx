    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              ...
              padding="0px 0px 0px 0px"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconqqz")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          >
            <Text
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Shareekv")}
            ></Text>
            <MyIcon
              width="24px"
              height="24px"
              ...
              {...getOverrideProps(overrides, "MyIconlhq")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="share"
              {...getOverrideProps(overrides, "MyIconbme")}
            ></MyIcon>
            <MyIcon
              width="24px"
              height="24px"
              ...
              padding="0px 0px 0px 0px"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconsem")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      >
        <MyIcon
          ...
          padding="0px 0px 0px 0px"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIcontjj")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read moreytd")}
        ></Text>
      </Flex>
    </Flex>
  );
