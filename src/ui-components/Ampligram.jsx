  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Image
            ...
            borderRadius="160px"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "imagecbo")}
          ></Image>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconbfh")}
          >
            <Icon
              width="4px"
              height="16px"
              ...
              left="41.67%"
              right="41.67%"
              {...getOverrideProps(overrides, "Vectorobh")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
      <Image
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "imagejiu")}
      ></Image>
      <Flex
        gap="16px"
        direction="row"
      ...
      >
        ...
        >
          <MyIcon
            ...
            {...getOverrideProps(overrides, "MyIconhsz")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            {...getOverrideProps(overrides, "MyIconfox")}
          ></MyIcon>
          <MyIcon
            width="24px"
            height="24px"
            ...
            padding="0px 0px 0px 0px"
            type="send"
            {...getOverrideProps(overrides, "MyIconuhq")}
          ></MyIcon>
        </Flex>
        <Flex
          gap="10px"
        ...
        >
          <View
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Iconrva")}
          >
            <Icon
              width="14px"
              height="18px"
              ...
              left="20.83%"
              right="20.83%"
              {...getOverrideProps(overrides, "Vectorxnw")}
            ></Icon>
          </View>
        </Flex>
      </Flex>
