...
var getClassName = function (suffix) { return styles_selectors_js_1.default["visible-content-" + suffix]; };
var VisibleContentPreferenceWrapper = (function (_super) {
    ...
    VisibleContentPreferenceWrapper.prototype.findToggleByIndex = function (groupIndex, optionIndex) {
        var groupSelector = "." + getClassName('groups') + " > *:nth-child(" + groupIndex + ")";
        var optionSelector = "." + getClassName('option') + ":nth-child(" + optionIndex + ")";
