...
var __1 = require("..");
var AttributeEditorRowWrapper = (function (_super) {
    ...
    AttributeEditorRowWrapper.prototype.findFields = function () {
        return this.findAllByClassName(styles_selectors_js_1.default.field).map(function (f) { return new __1.FormFieldWrapper(f.getElement()); });
    };
    AttributeEditorRowWrapper.prototype.findField = function (column) {
        return this.findComponent("." + styles_selectors_js_1.default['row-control'] + " > ." + styles_selectors_js_2.default.grid + " > ." + styles_selectors_js_2.default['grid-column'] + ":nth-child(" + column + ") > div > ." + styles_selectors_js_1.default.field, __1.FormFieldWrapper);
    };
    AttributeEditorRowWrapper.prototype.findRemoveButton = function () {
        return this.findComponent("." + styles_selectors_js_1.default['remove-button'], __1.ButtonWrapper);
    };
    return AttributeEditorRowWrapper;
}(dom_1.ElementWrapper));
exports.AttributeEditorRowWrapper = AttributeEditorRowWrapper;
var AttributeEditorWrapper = (function (_super) {
    ...
    AttributeEditorWrapper.prototype.findAddButton = function () {
        return this.findComponent("." + styles_selectors_js_1.default['add-button'], __1.ButtonWrapper);
    };
