...
var MultiselectWrapper = (function (_super) {
    ...
    MultiselectWrapper.prototype.findToken = function (tokenIndex) {
        var tokenGroup = this.findComponent("." + styles_selectors_js_2.default.root, token_group_1.default);
    ...
    MultiselectWrapper.prototype.isDisabled = function () {
