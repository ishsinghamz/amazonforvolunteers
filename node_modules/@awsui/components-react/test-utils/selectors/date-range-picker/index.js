...
var SelectionModeSwitchWrapper = (function (_super) {
...
var DrpDropdownWrapper = (function (_super) {
    ...
    DrpDropdownWrapper.prototype.findDateAt = function (grid, row, column) {
        ...
        return this.find("." + gridClassName + " ." + styles_selectors_js_1.default['calendar-week'] + ":nth-child(" + row + ") ." + styles_selectors_js_2.default.day + ":nth-child(" + column + ")");
    };
