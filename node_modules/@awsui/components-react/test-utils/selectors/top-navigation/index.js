...
var TopNavigationWrapper = (function (_super) {
    ...
    TopNavigationWrapper.prototype.findUtilities = function () {
        return this.findAll("." + styles_selectors_js_1.default['utility-wrapper'] + "[data-utility-index]").map(function (i) { return new TopNavigationUtilityWrapper(i.getElement()); });
    };
    ...
    TopNavigationWrapper.prototype.findOverflowMenu = function () {
        return (0, selectors_1.createWrapper)().findComponent("." + styles_selectors_js_1.default['overflow-menu-drawer'], OverflowMenu);
    };
...
var OverflowMenu = (function (_super) {
...
var TopNavigationUtilityWrapper = (function (_super) {
...
var TopNavigationMenuDropdownWrapper = (function (_super) {
