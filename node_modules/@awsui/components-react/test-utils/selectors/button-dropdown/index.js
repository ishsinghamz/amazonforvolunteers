...
var ButtonDropdownWrapper = (function (_super) {
    ...
    ButtonDropdownWrapper.prototype.findItemById = function (id) {
        var _a;
        var itemSelector = "." + styles_selectors_js_3.default['item-element'] + "[data-testid=\"" + id + "\"]";
    ...
    ButtonDropdownWrapper.prototype.findExpandableCategoryById = function (id) {
        var _a;
        var expandableCategorySelector = "." + styles_selectors_js_4.default.expandable + "[data-testid=\"" + id + "\"]";
    ...
    ButtonDropdownWrapper.prototype.findHighlightedItem = function () {
        var _a;
        var highlightedItemSelector = "." + styles_selectors_js_3.default['item-element'] + "." + styles_selectors_js_3.default.highlighted;
