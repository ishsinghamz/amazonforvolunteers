...
export declare function useMouseHover<T>({ plotRef, scaledSeries, barGroups, highlightSeries, highlightPoint, highlightGroup, clearHighlightedSeries, isGroupNavigation, isHandlersDisabled, }: UseMouseHoverProps<T>): {
    verticalMarkerLeft: number | null;
