...
export default function FilteringToken({ showOperation, operation, andText, orText, dismissAriaLabel, disabled, children, onChange, onDismiss, }: FilteringTokenProps): JSX.Element;
