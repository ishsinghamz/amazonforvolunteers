...
export declare namespace ChartModel {
    interface ComputedProps<T extends AreaChartProps.DataTypes> {
        xDomain: XDomain<T>;
        yDomain: YDomain;
        xScale: ChartScale;
