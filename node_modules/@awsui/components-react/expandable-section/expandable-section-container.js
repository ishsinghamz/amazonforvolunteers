...
export var ExpandableSectionContainer = function (_a) {
    ...
    if (variant === 'container') {
        return (React.createElement(InternalContainer, __assign({}, rest, { className: className, header: header, disableContentPaddings: disableContentPaddings || !expanded, disableHeaderPaddings: true, __internalRootRef: __internalRootRef }), children));
    }
