...
export function validate(tags, keyDirtyState, i18nStrings, charRegex) {
    if (charRegex === void 0) { charRegex = DEFAULT_CHAR_REGEX; }
    var tagKeysCache = {};
...
export var awsPrefixCheck = function (value) {
    return value.toLowerCase().indexOf(SYSTEM_TAG_PREFIX) === 0;
};
export var emptyKeyCheck = function (value) {
    return !value || value.trim().length === 0;
};
export var maxKeyLengthCheck = function (value) {
    return value && value.length > MAX_KEY_LENGTH;
};
export var duplicateKeyCheck = function (value, keyCache) {
    var _a;
    return ((_a = keyCache === null || keyCache === void 0 ? void 0 : keyCache[value]) !== null && _a !== void 0 ? _a : 0) > 1;
};
export var maxValueLengthCheck = function (value) {
    return value && value.length > MAX_VALUE_LENGTH;
};
export var invalidCharCheck = function (value, validCharRegex) {
    if (validCharRegex === void 0) { validCharRegex = DEFAULT_CHAR_REGEX; }
