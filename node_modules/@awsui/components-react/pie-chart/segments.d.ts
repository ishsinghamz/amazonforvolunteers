...
export default function Segments<T extends PieChartProps.Datum>({ pieData, highlightedSegment, size, variant, containerRef, focusedSegmentRef, popoverTrackRef, segmentAriaRoleDescription, onClick, onMouseOver, onMouseOut, }: SegmentsProps<T>): JSX.Element;
export {};
