...
var CalendarHeader = function (_a) {
    var baseDate = _a.baseDate, locale = _a.locale, onChangeMonth = _a.onChangeMonth, previousMonthLabel = _a.previousMonthLabel, nextMonthLabel = _a.nextMonthLabel, calendarHasFocus = _a.calendarHasFocus;
    return (React.createElement("div", { className: styles['calendar-header'] },
        ...
        React.createElement("div", { className: styles['calendar-header-month'], "aria-live": "polite" }, renderMonthAndYear(locale, baseDate)),
